...
export const FooterUI = React.forwardRef<HTMLDivElement, FooterProps>(
  ({ className, brand, socialLinks, columns, copyright, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn("pt-24 bg-background border-t border-border/50", className)}
        {...props}
      >
        <div className="max-w-screen-xl mx-auto px-4 lg:px-8">
          ...
          {copyright && (
            <div className="mt-20 border-t border-border/50 pt-6 pb-8">
